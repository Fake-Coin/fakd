...
func TestVersion(t *testing.T) {
	...
	tcpAddrMe := &net.TCPAddr{IP: net.ParseIP("127.0.0.1"), Port: 9333}
	me := NewNetAddress(tcpAddrMe, SFNodeNetwork)
	tcpAddrYou := &net.TCPAddr{IP: net.ParseIP("192.168.0.1"), Port: 9333}
...
func TestVersionOptionalFields(t *testing.T) {
	...
	uaVersion.UserAgent = "/fakdtest:0.0.1/"
...
var baseVersionEncoded = []byte{
	...
	0x20, 0x8d, // Port 9333 in big-endian
