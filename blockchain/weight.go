...
func GetBlockWeight(blk *fakutil.Block) int64 {
...
func GetTransactionWeight(tx *fakutil.Tx) int64 {
	msgTx := tx.MsgTx()
...
func GetSigOpCost(tx *fakutil.Tx, isCoinBaseTx bool, utxoView *UtxoViewpoint,
