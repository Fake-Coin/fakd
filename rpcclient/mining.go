...
func (c *Client) SubmitBlockAsync(block *fakutil.Block, options *btcjson.SubmitBlockOptions) FutureSubmitBlockResult {
	blockHex := ""
	if block != nil {
...
func (c *Client) SubmitBlock(block *fakutil.Block, options *btcjson.SubmitBlockOptions) error {
