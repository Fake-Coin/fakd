...
type PeerNotifier interface {
	...
	TransactionConfirmed(tx *fakutil.Tx)
}
...
func (b *blockManager) handleBlockchainNotification(notification *blockchain.Notification) {
	...
	case blockchain.NTBlockAccepted:
		...
		block, ok := notification.Data.(*fakutil.Block)
		if !ok {
...
// processed.
func (b *blockManager) QueueTx(tx *fakutil.Tx, peer *peerpkg.Peer, done chan struct{}) {
...
// processed.
func (b *blockManager) QueueBlock(block *fakutil.Block, peer *peerpkg.Peer, done chan struct{}) {
...
func (b *blockManager) ProcessBlock(block *fakutil.Block, flags blockchain.BehaviorFlags) (bool, error) {
